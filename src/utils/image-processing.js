...
/**
 * @typedef {{
 *   get2dContext: (canvas: HTMLCanvasElement | OffscreenCanvas | null) => CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D | null;
 *   getScaledCanvas: (canvas: HTMLCanvasElement, scaleFactor: number) => { canvas: HTMLCanvasElement; context: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D | null };
 *   addQuietZone: (canvas: HTMLCanvasElement) => { canvas: HTMLCanvasElement; context: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D | null };
 ...
 *   getBarcodeImagePayload: (canvas: HTMLCanvasElement) => { data: Uint8ClampedArray; width: number; height: number } | null;
